...
for interval_minute in interval_minutes:
    ...
    # (2) 데이터 로드
    history_data_path = 'psj/Adressa_1w/datas/1w_behaviors.tsv'
    ...
    # (2-2) news2int 적용
    news2int = pd.read_csv('./psj/Adressa_1w/datas/news2int.tsv', sep='\t')
    ...
    # (2-4) category2int 적용
    category2int = pd.read_csv('psj/Adressa_1w/datas/category2int_nyheter_splitted.tsv', sep='\t')
    ...
    g_save_path = f"./psj/Adressa_1w/datas/total_graph_full_reciprocal_{interval_minute}m.bin"
